<div class="main-sidebar">
    <aside id="sidebar-wrapper">
      <div class="sidebar-brand">
        <a href="{{ route('dashboard') }}">Edu Share</a>
      </div>
      ...
      <ul class="sidebar-menu">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="nav-link" href="#">General Information</a></li>
              <li><a class="nav-link" href="#">isi apa kek gitu</a></li>
            </ul>
          </li>
          <li class="menu-header">Content</li>
          <li class="nav-item dropdown">
            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>User Pages</span></a>
            <ul class="dropdown-menu">
        ...
        <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
          <a href="{{asset('https://getstisla.com/docs')}}" class="btn btn-primary btn-lg btn-block btn-icon-split">
